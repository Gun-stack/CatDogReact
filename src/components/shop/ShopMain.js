...
function ShopMain() {
    ...
    // shopinfo를 컴포넌트에 넘겨서 shopmainhome에서 shopinfo를 받아서 쓰기
                ...
                <section className="shop-main-section">
                    ...
                    <nav className="main-nav">
                        <ul className="main-nav-list">
                            ...
                            <li className="main-nav-list-text"><Link to="menu">메뉴</Link></li>
                            <li className="main-nav-list-text"><Link to ="designer">예약하기</Link></li>
                            <li className="main-nav-list-text"><Link to="style">스타일</Link></li>
                            <li className="main-nav-list-text"><Link to="review">리뷰</Link></li>
                        </ul>
                    </nav>
                    <hr className="divide-line" />

                    <Routes>
                        <Route path="/:num" element={<ShopMainHome shopInfo={shopInfo}/>}/>    
                        ...
                        <Route path="reservation" element={<ShopReservation shopInfo={shopInfo}/>}/>
                    </Routes>    
